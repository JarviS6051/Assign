                    ...
                    <div className="flex-1 flex flex-col p-4 h-80 overflow-hidden">
                        {tab === 'chat' ? (
                            <div className="flex flex-col h-full">
                                <div className="flex-1 flex flex-col overflow-y-auto space-y-2 pr-1">
                                    {messages.length === 0 ? (
                                        ...
                                        messages.map((msg, index) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={msg.sender === "Teacher"
                                                        ? { backgroundColor: "#373737", color: "#fff" }
                                                        : msg.sender === name
                                                            ? { backgroundColor: "#7765DA", color: "#fff" }
                                                            : { backgroundColor: "#7765DA", color: "#fff" }}
                                                >
